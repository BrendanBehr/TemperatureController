...
#define CYBLE_TEMPCONTROL_SERVICE_INDEX   (0x00u) /* Index of TempControl service in the cyBle_customs array */
#define CYBLE_TEMPCONTROL_DESIREDTEMP_CHAR_INDEX   (0x00u) /* Index of DesiredTemp characteristic */
#define CYBLE_TEMPCONTROL_DESIREDTEMP_CLIENT_CHARACTERISTIC_CONFIGURATION_DESC_INDEX   (0x00u) /* Index of Client Characteristic Configuration descriptor */
#define CYBLE_TEMPCONTROL_ACTUALTEMP_CHAR_INDEX   (0x01u) /* Index of ActualTemp characteristic */
#define CYBLE_TEMPCONTROL_ACTUALTEMP_CUSTOM_DESCRIPTOR_DESC_INDEX   (0x00u) /* Index of Custom Descriptor descriptor */
#define CYBLE_TEMPCONTROL_ACTUALTEMP_CLIENT_CHARACTERISTIC_CONFIGURATION_DESC_INDEX   (0x01u) /* Index of Client Characteristic Configuration descriptor */
#define CYBLE_TEMPCONTROL_CAPSENSE_CHAR_INDEX   (0x02u) /* Index of CapSense characteristic */
#define CYBLE_TEMPCONTROL_CAPSENSE_CUSTOM_DESCRIPTOR_DESC_INDEX   (0x00u) /* Index of Custom Descriptor descriptor */
#define CYBLE_TEMPCONTROL_CAPSENSE_CAPSENSECCCD_DESC_INDEX   (0x01u) /* Index of CapSenseCCCD descriptor */
#define CYBLE_TEMPCONTROL_CAPSENSE_CHARACTERISTIC_USER_DESCRIPTION_DESC_INDEX   (0x02u) /* Index of Characteristic User Description descriptor */


#define CYBLE_TEMPCONTROL_SERVICE_HANDLE   (0x0010u) /* Handle of TempControl service */
#define CYBLE_TEMPCONTROL_DESIREDTEMP_DECL_HANDLE   (0x0011u) /* Handle of DesiredTemp characteristic declaration */
#define CYBLE_TEMPCONTROL_DESIREDTEMP_CHAR_HANDLE   (0x0012u) /* Handle of DesiredTemp characteristic */
#define CYBLE_TEMPCONTROL_DESIREDTEMP_CLIENT_CHARACTERISTIC_CONFIGURATION_DESC_HANDLE   (0x0013u) /* Handle of Client Characteristic Configuration descriptor */
#define CYBLE_TEMPCONTROL_ACTUALTEMP_DECL_HANDLE   (0x0014u) /* Handle of ActualTemp characteristic declaration */
#define CYBLE_TEMPCONTROL_ACTUALTEMP_CHAR_HANDLE   (0x0015u) /* Handle of ActualTemp characteristic */
#define CYBLE_TEMPCONTROL_ACTUALTEMP_CUSTOM_DESCRIPTOR_DESC_HANDLE   (0x0016u) /* Handle of Custom Descriptor descriptor */
#define CYBLE_TEMPCONTROL_ACTUALTEMP_CLIENT_CHARACTERISTIC_CONFIGURATION_DESC_HANDLE   (0x0017u) /* Handle of Client Characteristic Configuration descriptor */
#define CYBLE_TEMPCONTROL_CAPSENSE_DECL_HANDLE   (0x0018u) /* Handle of CapSense characteristic declaration */
#define CYBLE_TEMPCONTROL_CAPSENSE_CHAR_HANDLE   (0x0019u) /* Handle of CapSense characteristic */
#define CYBLE_TEMPCONTROL_CAPSENSE_CUSTOM_DESCRIPTOR_DESC_HANDLE   (0x001Au) /* Handle of Custom Descriptor descriptor */
#define CYBLE_TEMPCONTROL_CAPSENSE_CAPSENSECCCD_DESC_HANDLE   (0x001Bu) /* Handle of CapSenseCCCD descriptor */
#define CYBLE_TEMPCONTROL_CAPSENSE_CHARACTERISTIC_USER_DESCRIPTION_DESC_HANDLE   (0x001Cu) /* Handle of Characteristic User Description descriptor */
