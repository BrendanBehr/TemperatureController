...
const CYBLE_CUSTOMS_T cyBle_customs[0x01u] = {
    ...
    /* TempControl service */
    {
        0x0010u, /* Handle of the TempControl service */ 
        {

            /* DesiredTemp characteristic */
            {
                0x0012u, /* Handle of the DesiredTemp characteristic */ 
            ...
            /* ActualTemp characteristic */
            {
                0x0015u, /* Handle of the ActualTemp characteristic */ 
            ...
            {
                0x0019u, /* Handle of the CapSense characteristic */ 
                
                /* Array of Descriptors handles */
                {
                    0x001Au, /* Handle of the Custom Descriptor descriptor */ 
                    0x001Bu, /* Handle of the CapSenseCCCD descriptor */ 
