...
module top ;
	...
	cy_clock_v1_0
		#(.id("a777cc2d-a9a7-4cda-b376-d33cb4e8b493"),
		  .source_clock_id(""),
		  .divisor(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("b83b4849-65df-405b-9daa-beca8153f03e"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
