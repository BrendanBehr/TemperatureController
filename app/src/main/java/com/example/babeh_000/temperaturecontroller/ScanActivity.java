...
public class ScanActivity extends AppCompatActivity {
    ...
    private void scanLeDevice(final boolean enable) {
        if (enable) { // enable set to start scanning
            ...
            mScanning = true;
            UUID[] temperatureControllerServiceArray = {CapSenseTemperatureControllerService.getTemperatureControllerServiceUUID()};
            if (Build.VERSION.SDK_INT < Build.VERSION_CODES.LOLLIPOP) {
                //noinspection deprecation
                mBluetoothAdapter.startLeScan(temperatureControllerServiceArray, mLeScanCallback);
                ...
                ParcelUuid PUuid = new ParcelUuid(CapSenseTemperatureControllerService.getTemperatureControllerServiceUUID());
