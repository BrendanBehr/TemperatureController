...
public class CapSenseTemperatureControllerService extends Service {
    ...
    private static BluetoothGattCharacteristic mDesiredTemperature;
    ...
    public static final String ACTION_CONNECTED =
            "com.example.babe_000.temperaturecontroller.ACTION_GATT_CONNECTED";
    public static final String ACTION_DISCONNECTED =
            "com.example.babe_000.temperaturecontroller.ACTION_GATT_DISCONNECTED";
    public static final String ACTION_DATA_AVAILABLE =
            "com.example.babe_000.temperaturecontroller.ACTION_DATA_AVAILABLE";
    ...
    private final BluetoothGattCallback mGattCallback = new BluetoothGattCallback() {
        ...
        public void onServicesDiscovered(BluetoothGatt gatt, int status) {
            if (status == BluetoothGatt.GATT_SUCCESS) {
                ...
                BluetoothGattService gattService = mBluetoothGatt.getService(UUID.fromString(TemperatureControllerUUID));
                if (gattService == null) return; // return if the motor service is not supported
                mActualTemperature = gattService.getCharacteristic(UUID.fromString(ActualTempUUID));
                mDesiredTemperature = gattService.getCharacteristic(UUID.fromString(DesiredTempUUID));
    ...
    public static UUID getTemperatureControllerServiceUUID() {
        return UUID.fromString(CapSenseTemperatureControllerService.TemperatureControllerUUID);
    }
